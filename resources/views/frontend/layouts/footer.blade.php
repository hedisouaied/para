                ...
                <div class="col-width-33 custom-common-column">
                    <div class="footer-widget footer-about-2 mb-40">
                        ...
                        <div class="footer-social-icon tooltip-style-4">
                            ...
                            <a aria-label="Linkedin" class="linkedin" href="{{get_setting('linkedin')}}" target="_blank" ><i class="fab fa-linkedin"></i></a>
                            <a aria-label="Twitter" class="twitter" href="{{get_setting('twitter')}}" target="_blank" ><i class="link-icon fab fa-twitter"></i></a>
                    ...
                    <div class="footer-widget mb-40">
                        ...
                        <div class="subscribe-wrap">
                            ...
                            <div class="subscribe-form">
                                <form class="validate subscribe-form-style" method="post" action="">
                                    <div  class="mc-form news_data">
                                        <input class="email news_id" type="email" required="" placeholder="Adresse email..." name="email">

                                        <div class="clear">
                                            <input class="button add-to-news-btn" type="submit" value="S'inscrire">
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        <div class="mobile-header-wrapper-inner">
            ...
            <div class="mobile-header-content-area">
                ...
                <div class="mobile-social-icon mt-20">
                    ...
                    <a class="facebook" href="{{get_setting('linkedin')}}" target="_blank"><i class="fab fa-linkedin"></i></a>
                    <a class="twitter" href="{{get_setting('twitter')}}" target="_blank"><i class="fab fa-twitter"></i></a>
