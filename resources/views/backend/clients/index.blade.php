        ...
        <tbody>
            @foreach ($users as $item)
                ...
                <tr>
                    ...
                    <td><img src="{{asset('frontend/assets/images/team/team-12.jpg')}}" alt="{{$item->title}}" style="width:100px;border-radius:50%;object-fit: cover;height: 100px;" /></td>
                    ...
                    <form action="{{route('clients.destroy',$item->id)}}" method="POST">
                        ...
                        <a class="float-left" href="{{route('clients.edit',$item->id)}}"><i class="btn btn-warning btn-sm waves-effect waves-light fas fa-pencil-alt" aria-hidden="true"></i></a>
                    </td>
