        ...
        <tbody>
            @foreach ($products as $item)
                ...
                <tr>
                    ...
                    <td>
                        @if ($item->discount == 0)
                            <span class="badge badge-danger" >{{$item->price}} TND</span>
                        @else
                        <del class="badge badge-danger" >{{$item->price}} TND</del><span class="badge badge-success" style="background: red;margin-left:5px;" >{{$item->price-(($item->price*$item->discount)/100)}} TND</span>
                        @endif
                    </td>
